(function($, win, doc) {
  ...
  function fnTouchmove(e, me) {
    ...
    if (
      ...
      if (!me.upInsertDOM) {
        me.$element.prepend(
          '<div class="' + me.opts.domUp.domClass + '"></div>'
        );
        me.upInsertDOM = true;
      }
      ...
      if (_absMoveY <= me.opts.distance) {
        ...
        _absMoveY > me.opts.distance &&
        _absMoveY <= me.opts.distance * 2
      ) {
        ...
        me._offsetY =
          me.opts.distance +
          me.opts.distance * 0.5 +
          (_absMoveY - me.opts.distance * 2) * 0.2;
      }
